    ...
    private void publishNow(
        ...
        if (expertUser != null) {
            ...
            realtimeService.pushUserDashboardEvent(
                    ...
                    serviceId,
                    "Dịch vụ AI đã được mua: " + safeServiceName
            );
            notificationService.notify(
                    ...
                    "Khách hàng đã mua '" + safeServiceName + "'. Bạn đã nhận được " + formattedAmount + "."
            );
        }
        ...
        realtimeService.pushUserDashboardEvent(
                ...
                ReferenceType.EXPERT_SERVICE,
                serviceId,
                "Đã hoàn tất mua dịch vụ AI: " + safeServiceName
        );
        ...
        if (sourceWalletId != null) {
            realtimeService.pushUserWalletEvent(
                    ...
                    sourceWalletId,
                    "Đã thanh toán dịch vụ AI: " + safeServiceName
            );
        }
    }
